  ...
  return (
    <div className="flex h-screen overflow-hidden bg-dark-900 relative">
      ...
      <div className="flex-1 flex flex-col min-h-0 relative z-10">
        <header className="relative z-50 h-16 bg-dark-800/60 backdrop-blur-xl border-b border-dark-600/50 flex items-center justify-between px-4 lg:px-6 shrink-0">
